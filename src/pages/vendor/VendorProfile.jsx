...
const VendorProfile = () => {
    ...
    return (
        <div className="space-y-6 md:space-y-10 pb-20 max-w-md mx-auto md:max-w-none px-2 mb-20">
            {/* Header Title */}
            <h1 className="text-2xl font-black text-slate-800 tracking-tight">Profile</h1>

            {/* Profile Info Card */}
            <div className="bg-white p-6 rounded-[2rem] border border-emerald-50 shadow-sm flex items-center gap-6 relative group overflow-hidden">
                <div className="absolute top-0 right-0 w-24 h-24 bg-primary/5 rounded-bl-[5rem] pointer-events-none" />
                <div className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-[#effaf6] flex items-center justify-center text-primary text-3xl font-black relative border-4 border-white shadow-lg shrink-0">
